...
CREATED assistent for studuing the lectures and large files
...
def create_or_update_assistant(client):
    ...
    assistant_config = {
        ...
        "model": "gpt-4o-mini",
        "instructions": """You are a helpful study assistant for easy study of lectures.

You can help with:
- Explaining lectures in easy language
